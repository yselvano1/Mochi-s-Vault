const APP_VERSION = "64.0.1"; // Bump versi ini setiap kali index.html/css/js berubah agar HP memperbarui cache
...
const LOCAL_ASSETS = [
  ...
  "./index.html",
  "./manifest.json",
  "./assets/mochi-logo-new.png",
  "./assets/mochi-rich-open.png",
  "./assets/mochi-rich-closed.png",
  "./assets/mochi-chill-open.png",
  "./assets/mochi-chill-closed.png",
  "./assets/mochi-anxious-open.png",
  "./assets/mochi-anxious-closed.png",
